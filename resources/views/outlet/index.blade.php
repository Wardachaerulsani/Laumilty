              ...
              <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <div class="media align-items-center">
                  ...
                  <div class="media-body  ml-2  d-none d-lg-block">
                    <span class="mb-0 text-sm  font-weight-bold">Warda Chaerul S</span>
                  </div>
                </div>
              </a>
                ...
                <div class="card">
                  ...
                  <!-- Light table -->
                      ...
                      <tr>
                        ...
                        <td>
                        {{-- edit produk --}}
                        <button type="submit" class="btn btn-outline-primary" data-toggle="modal" data-target="#formEditModal{{ $o->id }}">
                            Edit
                        </button>
                        {{-- delete-mobil --}}
