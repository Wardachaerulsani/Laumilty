<div class="modal fade" id="formEditModal{{ $pk->id }}" tabindex="-1" role="dialog" aria-labelleby="exampleModalLabel" aria-hidden="true">
<div class="modal-dialog" role="document">
    ...
    <form method="POST" action="{{ route('paket.update', $pk->id) }}">
          @csrf @method('put')
          <div id="method"></div>
            <div class="card-body mt--4">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="nama_paket" value="{{ $pk->nama_paket }}" placeholder="Nama Paket" name="nama_paket" >
              </div>
              <div class="form-group">
                <label for="harga">Harga</label>
                <input type="text" class="form-control" id="harga" value="{{ $pk->harga }}" placeholder="Harga" name="harga">
              </div>
            </div>
          </div>
            <!-- /.card-body -->
