    ...
    <nav class="navbar navbar-top navbar-expand navbar-dark bg-primary border-bottom">
      <div class="container-fluid">
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <!-- Search form -->
          <form action="/member" method="GET" class="navbar-search navbar-search-light form-inline mr-sm-3" id="navbar-search-main">
      ...
      <div class="container-fluid">
        <div class="header-body">
          ...
          <button class="btn btn-success" type="button" data-toggle="modal" data-target="#formInputModal">
            ...
            <a href="{{ route('export_member') }}" class="btn btn-default"><i class="ni ni-single-copy-04"> Export </i></a>
              ...
              <div class="col">
                <div class="card">
                  ...
                  <div class="card-box table-responsive">
                      ...
                      <table id="member-table" class="table align-items-center table-flush">
